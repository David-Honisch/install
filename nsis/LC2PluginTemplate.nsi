...
Name "START WINDOWS"
Caption "LC2PluginUpdate Install (c)by http://www.letztechance.org"
;Icon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"
Icon "${NSISDIR}\Examples\favicon.ico"
;OutFile "LC2PluginUpdateConfig${MyTIMESTAMP}.exe"
OutFile "LC2PluginUpdateConfig.exe"
...
;   MessageBox MB_OK "$INSTDIR\konfiguration.cfg not found. Creating configuration..."
	...
	Call GetInstallDirByRegistry
	Pop $1
	MessageBox MB_OK $1
	WriteINIStr "$INFILE"  "LC2Launcher.NET" "path" $1
     ;Abort ; causes installer to quit.
   NoAbort:
 ;  MessageBox MB_OK $S0$INSTDIR\konfiguration.cfg
 FunctionEnd
 
 Function GetInstallDirByRegistry
;// =====================================================================
;// Construct a product key 
;// =====================================================================
    ReadRegStr $1 HKCU "SOFTWARE\letztechance.org\LC2Launcher.NET" "Path"
	;MessageBox MB_OK $1	
FunctionEnd
...
Pop $1
MessageBox MB_OK $1
WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2PluginUpdate "LC2PluginUpdatePath" $1
WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2PluginUpdate "LC2PluginUpdate" 0123
WriteRegBin HKLM SOFTWARE\LETZTECHANCE.ORG\LC2PluginUpdate "LC2PluginUpdate" "DEADBEEF01F00DBEEF"
...
SetOutPath ".\"
    ...
    nsExec::ExecToStack '"LC2PluginUpdate.bat"'
SectionEnd
