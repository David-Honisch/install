...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "LC2MicrosoftKeyFinder"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "LC2MicrosoftKeyFinder"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "1.2.3"

;--------------------------------


Name "LC2MicrosoftKeyFinder"
Caption "LC2MicrosoftKeyFinder Install (c)by http://www.letztechance.org"
Icon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"
OutFile "LC2MicrosoftKeyFinderinstall.exe"
...
InstallDir "$PROGRAMFILES\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder"
InstallDirRegKey HKLM "Software\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder" "LC2MicrosoftKeyFinder"
...
;	CreateShortCut "$SMPROGRAMS\$R0\All users LC2MicrosoftKeyFinder.lnk" $INSTDIR\LC2MicrosoftKeyFinder.exe
;Abort
;!else
...
;MessageBox MB_YESNO "Wollen Sie dieses Programm wirklich installieren ?" IDYES
  ...
  WriteRegStr HKLM SOFTWARE\WWW.LETZTECHANCE.ORG\LC2MicrosoftKeyFinder "Install_Dir" "$INSTDIR"

  ; write uninstall strings
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2MicrosoftKeyFinder" "DisplayName" "LC2MicrosoftKeyFinder (remove only)"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2MicrosoftKeyFinder" "UninstallString" '"$INSTDIR\LC2MicrosoftKeyFinderuninst.exe"'
;---Extrahiere Dateien --------------------->
  SetOutPath $INSTDIR
  ;File /a "exe\LC2MicrosoftKeyFinder.exe"
  File /a "exe\*.*"
...
;  File /a "exe\WebSearch\*.*"
  ...
  WriteUninstaller "LC2MicrosoftKeyFinderuninst.exe"
;---Extrahiere Bilder --------------------->
...
SectionIn 1 4 3
  ...
  WriteRegStr HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder "StrTest_INSTDIR" "$INSTDIR"
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder "DwordTest_0xDEADBEEF" 0xdeadbeef
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder "DwordTest_123456" 123456
  WriteRegDword HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder "DwordTest_0123" 0123
  WriteRegBin HKLM SOFTWARE\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder "BinTest_deadbeef01f00dbeef" "DEADBEEF01F00DBEEF"
;  StrCpy $8 "$SYSDIR\LC"
...
Section "CreateShortCuts"
 ...
 CreateDirectory $SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder
 ;CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\Start LC2MicrosoftKeyFinder.lnk" $INSTDIR\start.bat
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\LC2MicrosoftKeyFinder.lnk" $INSTDIR\LC2MicrosoftKeyFinder.exe
 ;CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\LC2MicrosoftKeyFinder.exe" $INSTDIR\LC2MicrosoftKeyFinder.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\LC2MicrosoftKeyFinderuninst.lnk" $INSTDIR\LC2MicrosoftKeyFinderuninst.exe
 CreateShortCut "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\Support.lnk" $INSTDIR\letztechance.org.url
  SectionIn 1 2 3
...
Section "Programm und Hilfe ausführen..." TESTIDX
  ...
  SearchPath $1 $INSTDIR\LC2MicrosoftKeyFinder.exe
...
UninstallText "Uninstall LC2MicrosoftKeyFinder ?"
;UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\nsis1-uninstall.ico"
UninstallIcon "${NSISDIR}\Contrib\Graphics\Icons\lc.ico"

Section "Uninstall"

  DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\LC2MicrosoftKeyFinder"
  DeleteRegKey HKLM "SOFTWARE\WWW.LETZTECHANCE.ORG\LC2MicrosoftKeyFinder"

;  Delete "$SMPROGRAMS\WWW.LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\reg\*.*"
...
;  File /a "exe\lc2sys.dll"
  Delete "$INSTDIR\LC2MicrosoftKeyFinderuninst.exe"
  Delete "$INSTDIR\*.*"
  RMDir "$INSTDIR\"
  
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\LC2MicrosoftKeyFinder.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\LC2MicrosoftKeyFinderuninst.lnk"
  Delete "$SMPROGRAMS\$R0\LETZTECHANCE.ORG\LC2MicrosoftKeyFinder\Support.lnk"
